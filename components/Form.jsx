...
const Form = ({ type, postPrompt, setPostPrompt, submitting, handleSubmit }) => {
  return (
    <section className="w-full max-w-full flex-start flex-col">
      ...
      >
        <label>
          ...
          <textarea
            value={postPrompt.prompt}
            onChange={(e) => setPostPrompt({ ...postPrompt, prompt: e.target.value })}
        ...
        <label>
          ...
          <input
            ...
            onChange={(e) => setPostPrompt({ ...postPrompt, tag: e.target.value })}
            placeholder="#Tag"
            required
